    ...
    fun Build(navController: NavController) {
        ...
        val launcher = rememberLauncherForActivityResult(ActivityResultContracts.GetContent()) {
            if (it != null) {
                ...
                try {
                    importResult.value = MultiFormatReader().decodeWithState(BinaryBitmap(HybridBinarizer(qrcodeSource))).text
                } catch(_: Exception) {
