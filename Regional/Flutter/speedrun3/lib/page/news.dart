...
import 'package:speedrun3/service/news_favorite.dart';
...
class _NewsPageState extends State<NewsPage> {
  static final List<NewsData> _newsData = [
    NewsData("test title", "test author", "test datetime", "dnjfsfkadshjakharjeksdfsujiraeksdfdsijraefkdghsr"),
    NewsData("test title", "test author", "test datetime", "dnjfsfkadshjakharjeksdfsujiraeksdfdsijraefkdghsr"),
    NewsData("test title", "test author", "test datetime", "dnjfsfkadshjakharjeksdfsujiraeksdfdsijraefkdghsr"),
    NewsData("test title", "test author", "test datetime", "dnjfsfkadshjakharjeksdfsujiraeksdfdsijraefkdghsr"),
    NewsData("test title", "test author", "test datetime", "dnjfsfkadshjakharjeksdfsujiraeksdfdsijraefkdghsr"),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            trailing: IconButton(
              onPressed: () {
                newsFavoriteService.favorites.contains(data.id) ? 
                  newsFavoriteService.removeFavorite(data.id) :
                  newsFavoriteService.addFavorite(data.id);
              },
              icon: Icon(
                newsFavoriteService.favorites.contains(data.id) ?
                  Icons.star :
